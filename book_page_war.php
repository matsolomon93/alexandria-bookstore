  ...
  function clearBox(elementID)
{
  ...
  <!-- begin page content -->
    ...
    <div class="container-fluid">
      ...
      <?php 
          $result=mysqli_query($sqli, "SELECT * FROM books WHERE isbn = 1613821743");
      ...
      <div id="book_image" class="col-md-6">
        <img src="images/book_covers/art-of-war.jpg" id="catch1" draggable="true" ondragstart="drag(event)">
      <form action="main_book_page.php" method="post">
            <input type="hidden" name="wishlist" >
            <input type="submit" value="Add to wish list">
        </form>
        
        <form id="starrate" action="book_page_war.php" method="post">
          <div class="starRate">
        ...
        <form action="book_page_war.php" method="post">
