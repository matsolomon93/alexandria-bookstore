  ...
  function clearBox(elementID)
{
  ...
  <!-- begin page content -->  
    ...
    <div class="container-fluid">
      ...
      <?php 
          $result=mysqli_query($sqli, "SELECT * FROM books WHERE isbn = 0464832557");
      ...
      <div id="book_image" class="col-md-6">
        <img src="images/book_covers/hungergames.jpeg" id="catch1" draggable="true" ondragstart="drag(event)">
      <form action="book_page_hungergames.php" method="post">
