  ...
  function clearBox(elementID)
{
  ...
  <!-- begin page content --> 
    ...
    <div class="container-fluid">
      ...
      <?php 
          $result=mysqli_query($sqli, "SELECT * FROM books WHERE isbn = 1453606122");
      ...
      <div id="book_image" class="col-md-6">
        <img id="catch1" src="images/book_covers/benfrank.jpg" draggable="true" ondragstart="drag(event)">
       <form action="book_page_benfrank.php" method="post">
