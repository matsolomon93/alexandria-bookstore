  ...
  <body style="background-color: #4F9C80;">
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li class="active" ><a href="#"><span class="badge">14</span> All Books</a></li>
                <li class="divider"></li>
    ...
    <!-- Modal End -->  
          ...
          <div class="container-fluid">
            <h2 style="padding-bottom: 20px;">All Books</h2>
            <div class="row">
              <ol id="allbooksgroup"class="list-group">
                <li><a class="list-group-item" href="book_page_dune.php">Dune</a></li>
                <li><a class="list-group-item" href="book_page_children_dune.php">Children of Dune</a></li>
                <li><a class="list-group-item" href="book_page_penshaswar.php">The Peshawar Lancers</a></li>
                <li><a class="list-group-item" href="book_page_hungergames.php">The Hunger Games</a></li>
                <li><a class="list-group-item" href="book_page_design.php">The Design of Everyday Things</a></li>
                <li><a class="list-group-item" href="book_page_lotr1.php">The Fellowship of the Ring</a></li>
                <li><a class="list-group-item" href="book_page_lotr2.php">The Two Towers</a></li>
                <li><a class="list-group-item" href="book_page_lotr3.php">The Return of the King</a></li>
                <li><a class="list-group-item" href="book_page_prayers.php">Prayers for a Privileged People</a></li>
                <li><a class="list-group-item" href="book_page_leftbehind.php">Left Behind</a></li>
                ...
                <li><a class="list-group-item" href="book_page_money.php">The Total Money Makeover</a></li>
                <li><a class="list-group-item" href="book_page_war.php">The Art of War</a></li>
              </ol>
            </div>
          </div>
