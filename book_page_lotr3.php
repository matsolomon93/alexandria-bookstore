  ...
  function clearBox(elementID)
{
  ...
  <!-- begin page content --> 
    ...
    <div class="container-fluid">
      ...
      <?php 
          $result=mysqli_query($sqli, "SELECT * FROM books WHERE isbn = 0618574972");
      ...
      <div id="book_image" class="col-md-6">
        <img src="images/book_covers/returnofking.gif" id="catch1" draggable="true" ondragstart="drag(event)">
      <form action="main_book_page.php" method="post">
        ...
        <form action="book_page_lotr3.php" method="post">
